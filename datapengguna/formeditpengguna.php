                                ...
                                <div class="col-md-6">
                                    <form method="POST" action='fungsipengguna.php'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Nama" placeholder="Nama lengkap" value="<?php echo $pengguna['nama'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Nomor">Nomor : </label>
                                            <input type="text" class="form-control" name="Nomor"  maxlength="16" placeholder="Nomor" value="<?php echo $pengguna['nomor'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Jabatan</label>
                                            <?php $jabatan = $pengguna['jabatan']; ?>
                                            <select class="form-control" name="Jabatan">
                                                <option <?php echo ($jabatan == 'admin') ? "selected": "" ?>>Admin / Guru</option>
                                                <option <?php echo ($jabatan == 'siswa') ? "selected": "" ?>>Siswa</option>
                                            </select>
                                        </div>
