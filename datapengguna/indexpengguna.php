...
<a href="../login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                            ...
                            <p>
                                <?php
                                    if($_GET['notifikasi'] == 'sukses'){
                                        echo "Pendaftaran pengguna baru berhasil!";
                                    }   
               ...
               <div class="row">
                <div class="col-md-12">
                <a href="formpengguna.php" class="btn btn-primary"> Tambah Data </a>
                <hr />
                     <!-- Tabel -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    while($pengguna = mysqli_fetch_array($query)){
                                        ...
                                        echo "<td>".$pengguna['nomor']."</td>";
                                        echo "<td>".$pengguna['jabatan']."</td>";
                            
                                        echo "<td>";
                                        echo "<a href='formeditpengguna.php?id=".$pengguna['ID_Pengguna']."'><button class='btn btn-warning'>Edit</button></a> | ";
                                        echo "<a href='hapuspengguna.php?id=".$pengguna['ID_Pengguna']."'><button class='btn btn-danger'>Hapus</button></a>";
                                        echo "</td>";
