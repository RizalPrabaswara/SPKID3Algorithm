...
<a href="../login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                    ...
                    <div class="col-md-12">
                     <h2>Admin Dashboard</h2>   
                        ...
                        <?php if(isset($_GET['notifikasi'])): ?>
                            <p>
                                <?php
                                    if($_GET['notifikasi'] == 'hapusberhasil') {
                                        echo "Data  Berhasil Klasifikasi!";
                                    }
                                        else if($_GET['notifikasi'] == 'hapus') {
                                        echo "Data Tidak Berhasil Klasifikasi!";
                                    }
                                      else {
                                        echo "Data klasifikasi gagal!";
                                    }
                                ?>
                            </p>
                        <?php endif; ?>
               ...
               <div class="row">
                <div class="col-md-12">
                <a href="hitung_akurasi.php" class="btn btn-primary"> Hitung Akurasi </a>
                <hr />
                     <!-- Tabel -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                    include '../koneksi.php';
                                    $sql = "SELECT * FROM datauji";
                                    $query = mysqli_query($koneksi, $sql);
                            
                                    while($training = mysqli_fetch_array($query)){
                                        echo "<tr>";
                        
                                        echo "<td>".$training['ID_Uji']."</td>";
                                        echo "<td>".$training['IQ']."</td>";
                                        echo "<td>".$training['Rata_rata_Nilai_US']."</td>";
                                        echo "<td>".$training['Keaktifan']."</td>";
                                        echo "<td>".$training['Kedisiplinan']."</td>";
                                        echo "<td>".$training['Kerja_Sama']."</td>";
                                        echo "<td>".$training['Ketunaan']."</td>";
                                        echo "<td>".$training['Jenis_Sekolah']."</td>";
                                        echo "<td>".$training['Hasil_Klasifikasi']."</td>";
