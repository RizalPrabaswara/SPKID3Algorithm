                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    while($training = mysqli_fetch_array($query)){
                                        ...
                                        echo "<td>".$training['Nama_Siswa']."</td>";
                                        ...
                                        echo "<td>";
                                        echo "<a href='formedittraining.php?id=".$training['ID_Training']."'><button class='btn btn-warning'>Edit</button></a> | ";
                                        echo "<a href='hapustraining.php?id=".$training['ID_Training']."'><button class='btn btn-danger'>Hapus</button></a>";
                                        echo "</td>";
