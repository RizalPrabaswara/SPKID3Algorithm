...
<head>
    ...
    <title>Halaman Form Edit Rule</title>
	<!-- BOOTSTRAP STYLES-->
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="indexrule.php">Data Rule</a>
                            </li>
                            <li>
...
$sql = "SELECT * FROM rule WHERE ID_Rule=$id";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="POST" action='fungsirule.php'>
                                        <input type="hidden" name="ID_Rule" value="<?php echo $rule['ID_Rule'] ?>" />
                                        <div class="form-group">
                                            <label for="Parent">Parent : </label>
                                            <input type="text" class="form-control" name="Parent" placeholder="Parent" value="<?php echo $rule['Parent'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Akar">Akar : </label>
                                            <input type="text" class="form-control" name="Akar" placeholder="Akar" value="<?php echo $rule['Akar'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Parent">Aturan : </label>
                                            <input type="text" class="form-control" name="Aturan" placeholder="Aturan" value="<?php echo $rule['Aturan'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Keputusan">Keputusan : </label>
                                            <input type="text" class="form-control" name="Keputusan" placeholder="Keputusan" value="<?php echo $rule['Keputusan'] ?>"/>
                                        </div>
