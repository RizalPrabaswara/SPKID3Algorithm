...
<a href="../login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
               ...
               <div class="row">
                <div class="col-md-12">
                <a href="fungsibersih.php" class="btn btn-primary"> Bersihkan Data </a>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    while($rule = mysqli_fetch_array($query)){
                                        echo "<tr>";
                        
                                        echo "<td>".$rule['ID_Rule']."</td>";
                                        echo "<td>".$rule['Parent']."</td>";
                                        echo "<td>".$rule['Akar']."</td>";
                                        echo "<td>".$rule['Aturan']."</td>";
                                        echo "<td>".$rule['Keputusan']."</td>";
                            
                                        echo "<td>";
                                        // echo "<a href='formeditrule.php?id=".$rule['ID_Rule']."'><button class='btn btn-warning'>Edit</button></a> | ";
                                        echo "<a href='hapusrule.php?id=".$rule['ID_Rule']."'><button class='btn btn-danger'>Hapus</button></a>";
                                        echo "</td>";
